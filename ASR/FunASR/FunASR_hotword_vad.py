...
class ASR:
    ...
    def __init__(
        ...
        # model_cache_dir: str = "/mnt/disk/wjh23/.cache/modelscope/hub",
        ...
        # 模型初始化 model="paraformer-zh",  vad_model="fsmn-vad", punc_model="ct-punc",disable_update=True
        t0 = time.time()
    ...
    def batch_process(
        ...
        # 保存结果
        save_results_to_txt(df, output_file, sort=sort_results)
...
if __name__ == "__main__":
    ...
    asr.batch_process(
        ...
        output_file="/mnt/disk/wjh23/EaseDine/ASR/FunASR/FunASR_all_batch_results/uuid_hypothesis/batch_1_paraformer_zh_vad.txt",
        sort_results = False
    )
