...
# 打乱数据顺序
X_shuffled, y_shuffled = shuffle(combineds, labels, random_state=42)

# 对数据进行划分
train_corpus, test_corpus, train_labels, test_labels = train_test_split(X_shuffled, y_shuffled, test_size=0.2, random_state=0)
